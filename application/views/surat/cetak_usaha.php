...
<br /><br /><br />
<font align="justify">
    Yang bertanda tangan dibawah ini , <?php echo $usaha->jabatan_pejabat; ?> Desa Rambai Kecamatan Pariaman Selatan
...
<br>
<font align="justify">
    Menurut penelitian dan Pengantar RT setempat Nama/Orang tersebut benar Warga Desa Rambai Kecamatan Karawang
    Timur Kota Pariaman , bahwa yang bersangkutan benar Membuka / Mempunyai Usaha
...
<table width="100%">
    <tr>
        <td width="50%"></td>
        <td width="50%">
            <center>Rambai, <?= date('d F Y', strtotime($usaha->tanggal_usaha)); ?></center>
        </td>
    </tr>
    <tr>
        <td>
