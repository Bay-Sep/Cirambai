...
<br /><br />
<font align="justify">
    Nama / Orang tersebut benar Warga Desa Rambai Kecamatan Pariaman Selatan Kota Pariaman , Menerangkan dengan
...
<table width="100%">
    <tr>
        <td width="50%"></td>
        <td width="50%">
            <center>Rambai, <?= date('d F Y', strtotime($belum_sekolah->tanggal_belum_sekolah)); ?></center>
        </td>
    </tr>
    <tr>
        <td></td>
