...
<br /><br /><br />
<font align="justify">
    Yang bertandatangan di bawah ini , <?php echo $surat_kematian->jabatan_pejabat; ?> Desa Rambai Kecamatan
...
<table width="100%">
    <tr>
        <td width="50%"></td>
        <td width="50%">
            <center>Rambai, <?= date('d F Y', strtotime($surat_kematian->tanggal_surat_kematian)); ?></center>
        </td>
    </tr>
    <tr>
        <td></td>
