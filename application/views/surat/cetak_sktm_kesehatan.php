...
<br /><br /><br />
<font align="justify">
    Yang bertandatangan di bawah ini , <?php echo $sktm_kesehatan->jabatan_pejabat; ?> Desa Rambai Kecamatan
...
<table width="100%">
    <tr>
        <td width="50%"></td>
        <td width="50%">
            <center>Rambai, <?= date('d F Y', strtotime($sktm_kesehatan->tanggal_sktm_kesehatan)); ?></center>
        </td>
    </tr>
    <tr>
        <td></td>
