...
<br /><br /><br />
<font align="justify">
    Yang bertandatangan di bawah ini , Kepala Desa Rambai Kecamatan Pariaman Selatan Kota Pariaman menerangkan :
</font>
<table width="100%">
    <tr>
...
<table width="100%">
    <tr>
        <td width="50%"></td>
        <td width="50%">
            <center>Rambai, <?= date('d F Y', strtotime($domisili->tanggal_domisili)); ?> </center>
        </td>
    </tr>
    <tr>
        <td>
