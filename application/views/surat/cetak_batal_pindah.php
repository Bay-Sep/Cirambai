...
<br />
<font align="justify">
Menurut penilitian kami dan surat pengantar dari RT-nya bahwa Nama/Orang tersebut benar Warga Desa Rambai, dan bertempat tinggal dialamat tersebut diatas. Menerangkan bahwa yang bersangkutan diatas benar batal Pindah ke alamat di bawah ini;<br />
</font>
...
<table width="100%">
	<tr>
		<td width="50%"></td>
		<td width="50%"><center>Rambai, <?=date('d F Y', strtotime($batal_pindah->tanggal_batal_pindah));?></center></td>
	</tr>
	<tr>
		<td><center></center></td>
		<td><center>Kepala Desa Rambai</center></td>
	</tr>
	<tr>
		<td></td>
		<td><center>Kecamatan Pariaman Selatan</center></td>
	</tr>
	<tr>
		<td></td>
		<td></td>
