...
<br /><br /><br />
<font align="justify">
    Yang bertandatangan di bawah ini , <?php echo $haji->jabatan_pejabat; ?> Desa Rambai Kecamatan Pariaman Selatan
    Kota Pariaman Provinsi Sumatera Barat menerangkan bahwa:
</font>
<table width="100%">
    <tr>
...
<br />
<font align="justify">
    Nama tersebut diatas benar Warga Desa Rambai Kecamatan Pariaman Selatan Kota Pariaman Provinsi Sumatera Barat .
...
<table width="100%">
    <tr>
        <td width="50%"></td>
        <td width="50%">
            <center>Rambai, <?= date('d F Y', strtotime($haji->tanggal_haji)); ?></center>
        </td>
    </tr>
    <tr>
        <td></td>
