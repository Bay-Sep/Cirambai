...
<head>
    ...
    <link rel="shortcut icon" href="<?php echo base_url('assets/images/pariaman.png'); ?>">
    ...
    <div class="wrapper">
        <header class="main-header">
            <a href="<?php echo base_url('beranda'); ?>" class="logo">
                ...
                <span class="logo-lg"><img src="<?php echo base_url('assets/images/logo-pariaman.png'); ?>" width="27"
            ...
            <section class="sidebar">
                <ul class="sidebar-menu" data-widget="tree">
                    ...
                    <?php
                                                ...
                                                //jika kepala desa atau sekretaris
                                                if ($this->session->userdata('level') == 'kepaladesa' || $this->session->userdata('level') == 'sekretaris') {
                                                        ?>
