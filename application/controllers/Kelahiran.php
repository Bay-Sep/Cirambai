...
class Kelahiran extends CI_Controller
{
	...
	{
		$data['title'] = "Data kelahiran - Desa Rambai";
	...
	{
		$data['title'] = "Tambah kelahiran - Desa Rambai";
	...
	{
		$data['title'] = "Edit kelahiran - Desa Rambai";
	...
	{
		$data['title'] = "Detail kelahiran - Desa Rambai";
		$this->load->model('m_kelahiran');
