...
(4, 'Raihan Aditya Alfaridzi', 'Sabtu', 'Karwang', '2018-08-25', '00:00:00', 'Laki Laki', 'Pe', 'Laki Laki', 'Krajan 1 , Desa Rambaibambu kecamatan Pariaman Selatan Kota k', '3', '15', '3215262507750011', 'Karsa', 'wiraswasta', 'Krajan 1 , Desa Rambaibambu kecamatan Pariaman Selatan Kota karawang , 41371', '3215265404800010', 'Wiwin Maryani', 'Mengurus Rumah Tangga', 'Krajan 1 , Desa Rambaibambu kecamatan Pariaman Selatan Kota karawang , 41371'),
...
(0, 'Kantor Kepala Desa Rambai', '0000000000000000', 'A Suhani', 'Karawang', '77', 'Laki Laki', 'Islam', '-', 'SukaMulya ', '016', 'Kepala Dusun Sukamulya', 'Indonesia', 'Minggu', '2018-09-01', '08:00:00', '1', 'Rumah Duka', '1', '0000000000000000', '-', '0001-01-01', '-', 'Kepala Dusun Sukamulya', '0000000000000000', '-', '0001-01-01', '-', 'SukaMulya ');
...
(3215260112990001, 3215262108070011, 'Muhamad Husein', 'Karawang', '1999-12-04', 'Laki Laki', 'Sukamaju ,Desa Rambai , Kecamatan Pariaman Selatan Kota Karawan. 41371     ', '010', 'Kepala Dusun Sukamaju', 'Islam', 'Belum Menikah', 'SMA', 'Belum Bekerja', 'Tetap', '-', 'Indonesia'),
(3215260400820003, 3215261009140482, 'Agus Saefudin', 'Karawang', '1992-08-04', 'Laki Laki', 'Krajan 1 Desa Rambai , Kecamatan Pariaman Selatan Kota Karawan. 41371 ', '003', 'Kepala Dusun Krajan 1', 'Islam', 'Menikah', 'SMA', 'Mahasiswa', 'Tetap', '-', 'Indonesia'),
(3215260401050001, 3215262108070011, 'Tedi Rahman', 'Karawang', '2005-01-04', 'Laki Laki', 'Sukamaju ,Desa Rambai , Kecamatan Pariaman Selatan Kota Karawan. 41371 ', '010', 'Kepala Dusun Sukamaju', 'Islam', 'Belum Menikah', 'SMP', 'Belum Bekerja', 'Tetap', '-', 'Indonesia'),
(3215260607060001, 3215262108070011, 'Sugiri', 'Karwang', '2006-07-06', 'Laki Laki', 'Sukamaju ,Desa Rambai , Kecamatan Pariaman Selatan Kota Karawan. 41371 ', '010', 'Kepala Dusun Sukamaju', 'Islam', 'Belum Menikah', 'SMP', 'Belum Bekerja', 'Tetap', '-', 'Indonesia'),
(3215261607780001, 3215267007900001, 'Suhendar', 'Karawang', '1987-07-16', 'Laki Laki', 'Sukamaju ,Desa Rambai , Kecamatan Pariaman Selatan Kota Karawan. 41371  ', '001', 'Kepala Dusun Sukamaju', 'Islam', 'Menikah', 'SMP', 'Buruh', 'Tetap', '-', 'Indonesia'),
(3215262207990004, 3215261009140482, 'Angga Nugraha', 'Karawang', '1999-07-22', 'Laki Laki', 'Krajan 1 Desa Rambai , Kecamatan Pariaman Selatan Kota Karawan. 41371 ', '003', 'Kepala Dusun Krajan 1', 'Islam', 'Belum Menikah', 'SMA', 'Pelajar', 'Tetap', '-', 'Indonesia'),
(3215262701170002, 3215262108070011, 'David Syahputra', 'Karawang', '2017-01-21', 'Laki Laki', 'Sukamaju ,Desa Rambai , Kecamatan Pariaman Selatan Kota Karawan. 41371 ', '010', 'Kepala Dusun Sukamaju', 'Islam', 'Belum Menikah', 'Tidak Sekolah', 'Belum Bekerja', 'Tetap', '-', 'Indonesia'),
(3215264206720008, 3215262108070011, 'Sarni', 'Karawang', '1972-08-02', 'Perempuan', 'Krajan 1 Desa Rambai , Kecamatan Pariaman Selatan Kota Karawan. 41371       ', '003', 'Kepala Dusun Krajan 1', 'Islam', 'Belum Menikah', 'Tidak Tamat SD', 'Mengurus Rumah Tangg', 'Tetap', '-', 'Indonesia'),
...
(3215266909080001, 3215262108070011, 'Rita Khodijah', 'Karawang', '2008-09-29', 'Perempuan', 'Sukamaju ,Desa Rambai , Kecamatan Pariaman Selatan Kota Karawan. 41371 ', '010', 'Kepala Dusun Sukamaju', 'Islam', 'Belum Menikah', 'SD', 'Belum Bekerja', 'Tetap', '-', 'Indonesia'),
(3215267007900001, 3215262108070011, 'Ijah', 'Karawang', '1990-07-30', 'Perempuan', 'Sukamaju ,Desa Rambai , Kecamatan Pariaman Selatan Kota Karawan. 41371    ', '010', 'Kepala Dusun Sukamaju', 'Islam', 'Menikah', 'SMA', 'Megurus Rumah Tangga', 'Tetap', '-', 'Indonesia');
...
(1, 1, '75765757', '111111111', 'Keamanan', 'Kp cikedokan desa sukadanau Rt 01/01 dusun 1 no 142, cikarang barat', 'adsd', '7', '77676', 'kkuhuhb', '17845', 'Tegal', 'Sumatera Barat', 17845, '087730384035', '2019-11-19'),
...
CREATE TABLE `user` (
  ...
  `level` enum('admin','sekretaris','kepaladesa') NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
